...
@push('pageJs')
    ...
    <script type="text/javascript">
        // routes
        const CREATE_ROUTE = '{{ route('admin.category-attributes.create') }}'
        const EDIT_ROUTE = '{{ route('admin.category-attributes.edit', '_ID_') }}'
        const DELETE_ROUTE = '{{ route('admin.category-attributes.destroy', '_ID_') }}'
        ...
        const DATATABLE = '#CategoryAttribute-table'
