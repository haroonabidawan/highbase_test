...
@push('pageJs')
    ...
    <script type="text/javascript">
        // routes
        const CREATE_ROUTE = '{{ route('admin.categories.create') }}'
        const EDIT_ROUTE = '{{ route('admin.categories.edit', '_ID_') }}'
        const DELETE_ROUTE = '{{ route('admin.categories.destroy', '_ID_') }}'
